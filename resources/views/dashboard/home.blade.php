          ...
          <tbody>
              @foreach ($services as $service)
                  <tr>
                      ...
                      <td>
                        <a href="service/{{$service->id }}" class="btn btn-info text-decoration-none">Detail</a>
                        <form action="service/{{$service->id }}" method="POST" class="d-inline" onsubmit="return confirmDelete()">
                            @csrf
                            @method('DELETE')
